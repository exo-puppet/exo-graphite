...
#        $apache_conf_dir          = "${install_dir}/apache"
        ...
        $packages           = [ "python-django", "python-django-tagging", "python-memcache", "python-cairo", "python-amqplib", "python-twisted", "python-twisted-core", "python-twisted-web", "python-twisted-names", "python-simplejson", "python-ldap" ]
